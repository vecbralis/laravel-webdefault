						...
						<tr><td align="left" valign="middle">
							...
							<table width="115" border="0" cellspacing="0" cellpadding="0" >
								<tr><td align="left" valign="top" class="mob_center">
									...
									<img src="{{ Config::get('app.emailLogoLink') }}" width="{{ Config::get('app.emailLogoWidth') }}" height="{{ Config::get('app.emailLogoHeight') }}" alt="{{ Config::get('app.emailLogoTitle') }}" border="0" style="display: block;" /></font></a>
								</td></tr>
							</table>						
						</td></tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					{{ date("Y") }} {{ Config::get('app.copyRightEmail') }}
				</span></font>				
			</td></tr>			
		</table>
